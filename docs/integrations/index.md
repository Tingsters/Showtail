...
<!-- showtail:start sha=bb508022f950 -->
...
| **Entity-level diffs** | ✅ | 🚧 | ⛔ | 🚧 | 🚧 | 🗺️ | 🚧 | 🚧 | ⛔ | ⛔ | Runs in the shared artifact path using bundled tree-sitter grammars (17 languages), so any tool that snapshots a file gets it; the delta is silent for unsupported languages. Live-certified for Claude Code. |
